...
public class RequestSupportController implements Initializable {
     ...
     * <li>
     * Initializes the {@link RequestSupportExecutor} if it isn't already
     * initialized.<br>
     * <small>
     * Register callback methods
     * {@link RequestSupportController#openConnected(javafx.stage.Stage) openConnected}
     * and
     * {@link RequestSupportController#openConnectedFailed(javafx.stage.Stage) openConnectedFailed}.</small>
     * </li>
     * <li>Calls {@link RequestSupportExecutor#connect(ch.imedias.rscc.model.SupportAddress, java.lang.Double)
     * }.</li>
     * </ol>
     *
     * @param event
    ...
    /**
     * Callback method for {@link RequestSupportExecutor} if if client
     * successfully connected to supporter.
     *
    ...
    /**
     * Callback method for {@link RequestSupportExecutor} if connecting to
     * supporter failed.
     *
     * @param stage window that needs to be changed
     */
